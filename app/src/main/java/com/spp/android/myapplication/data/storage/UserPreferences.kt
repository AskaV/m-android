...
class UserPreferences @Inject constructor(
    ...
    override val rememberMe: Flow<Boolean> = dataStore.data.map { prefs ->
        prefs[REMEMBER_ME] ?: false
    }

    override val savedEmail: Flow<String> = dataStore.data.map { prefs ->
        prefs[USER_EMAIL] ?: ""
    }

    override suspend fun saveUser(email: String, remember: Boolean) {
